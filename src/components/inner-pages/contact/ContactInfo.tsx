...
const contact_data: DataType[] = [
   {
      ...
      contact_info: [
         {
            info_link: "callto:+(234)7025608111)",
            info_title: "+234 702 560 8111"
         },
   ...
   },
   {
      ...
      contact_info: [
         {
            info_link: "mailto:SistersUnite4Children@gmail.com",
            info_title: "SistersUnite4Children@gmail.com"
         }, 
      ]
   },
   {
      ...
      contact_info_text: (<>26 Awkuzu Street, Lekki Phase 1 <br />Lagos State</>),
   },
]
