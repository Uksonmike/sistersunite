...
const tab_content: JSX.Element[] = [
   (<>To rescue, rehabilit ate, and reintegrate indigent children into society through advocacy,
capacity building, care,
counseling, education, life skill training, and creation
of linkages aimed at reducin g poverty, all powered by faith
in Jesus Christ.
</>),
   (<>A society where vulnerable children are empowered to live productive lives, with
their dignity restored.</>),
   (<>Our Values: Compassion, Integrity, Inclusion, Impact</>),
]
