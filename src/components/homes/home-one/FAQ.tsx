...
const coreValuesData: DataType[] = [
   {
      ...
      answer: "Ensuring children's safety and well-being in all our programs and activities.",
   },
   {
      id: 2,
      page: "home_1", 
      question: "Integrity & Accountability",
      answer: "Operating with transparency, honesty, and responsibility in all our actions and decisions.",
   },
   {
      id: 3,
      page: "home_1",
      question: "Collaboration & Partnership",
      answer: "Working together with stakeholders, communities, and partners for greater impact and sustainable change.",
   },
   {
      id: 4,
      page: "home_1",
      question: "Service & Compassion",
      answer: "Prioritizing the needs of children and families with empathy, care, and genuine concern.",
   },
   {
      id: 5,
      page: "home_1",
      question: "Excellence & Innovation",
      answer: "Delivering sustainable and creative solutions through continuous improvement and innovative approaches.",
   },
];
...
const CoreValues = () => {
   ...
   useEffect(() => {
      const initialValuesData: DataType[] = coreValuesData.filter((item) => item.page === "home_1").slice(0,5).map((value, index) => ({
         ...value,
         showAnswer: index === 0,
      }));
               ...
               <div className="col-lg-6">
                  <div className="faq-content-part rmt-65 rel z-2">
                        <div className="section-title mb-45 for-hide-summary">
                            <span className="section-title__subtitle mb-10">Our Foundation</span>
                            <h2>Core <span>Values</span></h2>
                            <p>Guiding principles that define our commitment to protecting children and strengthening communities through ethical, collaborative, and compassionate service.</p>
                        </div>
