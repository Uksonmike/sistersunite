            ...
            <div className="row justify-content-center">
               <div className="col-xl-6 col-lg-8 col-md-10">
                  <div className="section-title text-center mb-65">
                     <span className="section-title__subtitle mb-10">Past Events</span>
                     <h3>Event Gallery</h3>
                     <p>From empowering workshops to joyous celebrations and intimate networking sessions, every photograph tells a story of connection, growth, and shared purpose.</p>
                  </div>
               </div>
            </div>
